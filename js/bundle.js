...
module.exports = {
    animationsEnabled: true, //enable for CRAZY entrance animations
    itemHeight: 200 + 60, // height + margin
    itemWidth: 160 + 60, // width + margin
    apps: [{
        name: 'Temperature'
    }, {
        name: 'Find Friends'
...
window.onresize = windowResizer.bind(undefined, false); // no anim on resize
...
},{"./config":1,"jquery":3}],3:[function(require,module,exports){
/*!
